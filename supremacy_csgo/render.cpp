...
// TODO hook CYR/CN/JP/KR support without forcing english
void render::init() {
	menu = Font(XOR("Smallest Pixel-7"), 11, FW_NORMAL, FONTFLAG_NONE | FONTFLAG_OUTLINE);
	menu_icon = Font(XOR("Icons Social Media 1"), 50, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	menu_shade = Font(XOR("Smallest Pixel-7"), 11, FW_NORMAL, /*| FONTFLAG_DROPSHADOW*/ FONTFLAG_OUTLINE);
	esp = Font(XOR("Smallest Pixel-7"), 11, FW_NORMAL, FONTFLAG_ANTIALIAS /*| FONTFLAG_DROPSHADOW*/ | FONTFLAG_OUTLINE);
	esp_small = Font(XOR("Smallest Pixel-7"), 11, FW_NORMAL, FONTFLAG_ANTIALIAS /*| FONTFLAG_DROPSHADOW*/ | FONTFLAG_OUTLINE);
	hud = Font(XOR("Smallest Pixel-7"), 11, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	cs = Font(XOR("Counter-Strike"), 28, FW_MEDIUM, FONTFLAG_ANTIALIAS /*| FONTFLAG_DROPSHADOW*/ | FONTFLAG_OUTLINE);
	indicator = Font(XOR("Verdana"), 26, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
...
void render::rect_filled_fade_scope(int x, int y, int w, int h, Color color, int a1, int a2) {
	g_csgo.m_surface->DrawSetColor(color);
	g_csgo.m_surface->DrawFilledRectFade(x, y, w, h, a1, a2, false);
}
