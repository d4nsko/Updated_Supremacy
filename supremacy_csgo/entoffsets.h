...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flHealthShotBoostExpirationTime;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR( m_flHealthShotBoostExpirationTime,                   HASH("DT_CSPlayer"), HASH("m_flHealthShotBoostExpirationTime"));
