...
void Form::draw( ) {
	...
	if( !m_tabs.empty( ) ) {
		...
		for( size_t i{}; i < m_tabs.size( ); ++i ) {
			...
			/*render::menu_shade.string( tabs_area.x + 30, tabs_area.y + 5 + ( i * 20),
			...
			if (i == 0)
			{
				render::menu_icon.string(tabs_area.x + 25, tabs_area.y + 10 + 15,
					t == m_active_tab ? color : Color{ 152, 152, 152, m_alpha },
					":");
			}
			else if (i == 1)
			{
				render::menu_icon.string(tabs_area.x + 25, tabs_area.y + 10 + 15 + 60,
					t == m_active_tab ? color : Color{ 152, 152, 152, m_alpha },
					"T");
			}
			else if (i == 2)
			{
				render::menu_icon.string(tabs_area.x + 25, tabs_area.y + 10 + 15 + 120,
					t == m_active_tab ? color : Color{ 152, 152, 152, m_alpha },
					"D");
			}
			else if (i == 3)
			{
				render::menu_icon.string(tabs_area.x + 25, tabs_area.y + 10 + 15 + 180,
					t == m_active_tab ? color : Color{ 152, 152, 152, m_alpha },
					"2");
			}
			else if (i == 4)
			{
				render::menu_icon.string(tabs_area.x + 25, tabs_area.y + 10 + 15 + 240,
					t == m_active_tab ? color : Color{ 152, 152, 152, m_alpha },
					"t");
			}
			else if (i == 5)
			{
				render::menu_icon.string(tabs_area.x + 25, tabs_area.y + 10 + 15 + 300,
					t == m_active_tab ? color : Color{ 152, 152, 152, m_alpha },
					"k");
			}
			else if (i == 6)
			{
				render::menu_icon.string(tabs_area.x + 25, tabs_area.y + 10 + 15 + 360,
					t == m_active_tab ? color : Color{ 152, 152, 152, m_alpha },
					"V");
			}
		}
