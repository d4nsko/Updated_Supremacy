...
public:
	...
	void SetupMaterial(IMaterial* mat, Color col, bool z_flag, bool enabled);
	...
	IMaterial* half_wire;
	IMaterial* glass;
	IMaterial* mat_overlay;
	IMaterial* custom_material;
	IMaterial* custom_material_arm;
	IMaterial* fakelag_material;
};
