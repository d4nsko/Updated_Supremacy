...
int Hooks::DebugSpreadGetInt() {
	if (g_cl.m_processing && /*!g_cl.m_local->m_bIsScoped()*/!scopeValue && g_menu.main.visuals.force_xhair.get())
		return 3;
...
bool Hooks::NetShowFragmentsGetBool() {
	if (!g_csgo.m_engine->IsInGame())
		return g_hooks.m_net_show_fragments.GetOldMethod< GetBool_t >(13)(this);
