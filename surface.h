...
public:
	...
	__forceinline void SetMouseInputEnabled(unsigned int panel, bool state) {
		return util::get_method< void(__thiscall*)(PVOID, int, bool)>(this, SETMOUSEINPUTENABLED)(this, panel, state);
	}
};
