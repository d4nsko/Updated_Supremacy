...
void Skins::think() {
	...
	// store knife index.
	KnifeData* knife = &m_knife_data[g_menu.main.config.knife.get()];
	...
	for (int i{ 1 }; i <= g_csgo.m_entlist->GetHighestEntityIndex(); ++i) {
		...
		// run knifechanger.
		if (g_menu.main.config.knife.get() > 0 && ent->is(HASH("CPredictedViewModel"))) {
			...
			if (weapon->IsKnife()) {
				...
				if (g_menu.main.config.knife.get() > 0) {
					...
					weapon->m_nFallbackPaintKit() = g_menu.main.config.knife_id.get();	// hmm
				}

				else if (g_menu.main.config.knife.get() == 0) {
					// fix definition.
			...
			case DEAGLE:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_deagle.get();
				break;
			case ELITE:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_elite.get();
				break;
			case FIVESEVEN:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_fiveseven.get();
				break;
			case GLOCK:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_glock.get();
				break;
			case AK47:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_ak47.get();
				break;
			case AUG:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_aug.get();
				break;
			case AWP:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_awp.get();
				break;
			case FAMAS:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_famas.get();
				break;
			case G3SG1:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_g3sg1.get();
				break;
			case GALIL:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_galil.get();
				break;
			case M249:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_m249.get();
				break;
			case M4A4:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_m4a4.get();
				break;
			case MAC10:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_mac10.get();
				break;
			case P90:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_p90.get();
				break;
			case UMP45:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_ump45.get();
				break;
			case XM1014:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_xm1014.get();
				break;
			case BIZON:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_bizon.get();
				break;
			case MAG7:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_mag7.get();
				break;
			case NEGEV:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_negev.get();
				break;
			case SAWEDOFF:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_sawedoff.get();
				break;
			case TEC9:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_tec9.get();
				break;
			case P2000:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_p2000.get();
				break;
			case MP7:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_mp7.get();
				break;
			case MP9:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_mp9.get();
				break;
			case NOVA:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_nova.get();
				break;
			case P250:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_p250.get();
				break;
			case SCAR20:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_scar20.get();
				break;
			case SG553:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_sg553.get();
				break;
			case SSG08:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_ssg08.get();
				break;
			case M4A1S:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_m4a1s.get();
				break;
			case USPS:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_usps.get();
				break;
			case CZ75A:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_cz75a.get();
				break;
			case REVOLVER:
				weapon->m_nFallbackPaintKit() = g_menu.main.config.id_revolver.get();
				break;
	...
	if (g_menu.main.config.glove.get() > 0) {
		...
		// store glove data.
		GloveData* data = &m_glove_data[g_menu.main.config.glove.get()];
		...
		// set custom data.
		glove->m_nFallbackPaintKit() = 10000 + g_menu.main.config.glove_id.get();
...
void Skins::UpdateAnimations(Entity* ent) {
	int knife = g_menu.main.config.knife.get();
